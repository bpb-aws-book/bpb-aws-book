		...
		"WebServer": {
			...
			"Metadata": {
				"AWS::CloudFormation::Init": {
					"configSets": {
						"All": [
							"InstallDjangoApplication", "ConfigureGunicorn"
						]
					},
					"InstallDjangoApplication": {
						...
						"commands": {
							...
							"copy required files":{
                                "command": "cp -r bpb-aws-book/chapter4/inquisitive_bookworm_club .",
                                "cwd": "/home/ec2-user"
                            },
				...
				"commands": {
                            "install and enable gunicorn":{
                                "command": "systemctl daemon-reload && systemctl start gunicorn.socket && systemctl enable gunicorn.socket",
                                "cwd": "/home/ec2-user"
                            }
						}
                },
